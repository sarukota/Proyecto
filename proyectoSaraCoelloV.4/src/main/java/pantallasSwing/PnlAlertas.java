...
public class PnlAlertas extends javax.swing.JPanel {
    ...
    private DefaultTableModel dtmHoy;
    private DefaultTableModel dtmManiana;
    private DefaultTableModel dtmSiguientes;
    ...
    public void configInicial(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "No se han podido recuperar los datos de las alertas.","Error",0);
        }
    }
            ...
            if (opcion == 0){ //ACEPTAR
                String sentenciaSQL = "DELETE FROM alertas WHERE "+dtm.getColumnName(0)+ "=?;";
                    try {  
                        ...
                        Logger.getLogger(PnlAlertas.class.getName()).log(Level.SEVERE, null, ex);
                        JOptionPane.showMessageDialog(this, "No se ha podido eliminar la alerta.","Error",0);
                    }
            }
    }
    ...
    public void eliminarFila(){
        if (tblHoy.getSelectedRow() < 0 & tblManiana.getSelectedRow() < 0 & tblSiguientes.getSelectedRow() < 0){
            JOptionPane.showMessageDialog(this,"Selecciona una alerta","Aviso",-1);
        }
        else{
    ...
    private void initComponents() {
        ...
        bntEliminarAlerta = new javax.swing.JButton();
        ...
        bntEliminarAlerta.setBackground(new java.awt.Color(255, 0, 51));
        bntEliminarAlerta.setFont(new java.awt.Font("Rockwell Nova", 0, 12)); // NOI18N
        bntEliminarAlerta.setForeground(new java.awt.Color(255, 255, 255));
        bntEliminarAlerta.setText("Eliminar alerta");
        bntEliminarAlerta.setBorder(null);
        bntEliminarAlerta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bntEliminarAlertaActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(bntEliminarAlerta, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(34, 34, 34)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(bntEliminarAlerta, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(15, 15, 15)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
                ...
                JOptionPane.showMessageDialog(this,"Se ha añadido la nueva alerta","Aviso",1);
                pnlNuevaAlerta.setVisible(false);
                ...
                if (ex.getMessage().toLowerCase().contains("duplicate")) { // Si el mensaje es entrada duplicada, es porque se repite la matrícula
                    JOptionPane.showMessageDialog(this, "Ya existe una alerta con ese título","Error",0);
                }
                else {
                    JOptionPane.showMessageDialog(this, "No se ha podido añadir la alerta","Error",0);
                }
            }
        } else{
    ...
    private void bntEliminarAlertaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntEliminarAlertaActionPerformed
        eliminarFila();
        configInicial();
    }//GEN-LAST:event_bntEliminarAlertaActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton bntEliminarAlerta;
