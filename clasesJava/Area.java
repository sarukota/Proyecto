...
public class Area {
    ...
    public String toString() {
        return "Area{" + "direccion=" + direccion + ", telefono=" + telefono + ", mail=" + mail + ", web=" + web + ", numParcelas=" + numParcelas + ", precioNoche=" + precioNoche + ", pathMapa=" + pathMapa + ", informacion=" + informacion + ", Servicios=" + Servicios + '}';
    }
