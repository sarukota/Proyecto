...
public class PnlInfoParcelas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(212, 72, 168));

        tfMatricula.setEditable(false);
        tfMatricula.setBackground(new java.awt.Color(212, 72, 168));
        ...
        tfModelo.setBackground(new java.awt.Color(212, 72, 168));
        ...
        tfMarca.setBackground(new java.awt.Color(212, 72, 168));
        ...
        tfCheckIn.setBackground(new java.awt.Color(212, 72, 168));
        ...
        tfCheckOut.setBackground(new java.awt.Color(212, 72, 168));
