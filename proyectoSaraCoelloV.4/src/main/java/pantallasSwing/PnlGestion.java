...
public class PnlGestion extends javax.swing.JPanel{
    ...
    private Object buscarPor;
    private Calendar calendario = Calendar.getInstance();
    private Date fechaHoy;
    private DefaultTableModel dtmResult;
    ...
    public void llenarTablaBuscar() throws SQLException{
        ...
        if (buscarPor == "Por vehiculo"){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "No se han podido recuperar los datos de los vehículos.","Error",0);
            }    
            ...
            try {
                ...
                Logger.getLogger(Interfaz.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "No se han podido recuperar los datos de los clientes.","Error",0);
            }
        }else{
            ...
            try {
                ...
                Logger.getLogger(Interfaz.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "No se han podido recuperar los datos de las parcelas.","Error",0);
            }
        }
        editarDatos();
    }
                    ...
                    if (e.getType() == TableModelEvent.UPDATE) {
                        ...
                        if ("vehiculos".equals(nombreTbl.toLowerCase()) && "num_parcela".equals(nombreColumna.toLowerCase())) 
                            ...
                            try {
                                ...
                                JOptionPane.showMessageDialog(null, "No se han podido actualizar los datos.","Error",0);
                            } 
                        }
    ...
    public void eliminarFila(){
        if (tblResult.getSelectedRow() < 0|| tblResult.getSelectedRowCount() > 1)
            JOptionPane.showMessageDialog(this,"Selecciona una fila","Error",0); //Si no hay fila seleccionada
        else{
            ...
            if (opcion == 0){ //ACEPTAR
                String sentenciaSQL = "DELETE FROM "+nombreTbl+" WHERE "+dtmResult.getColumnName(0)+ "=?;";
                    try {
                        ...
                        Logger.getLogger(PnlGestion.class.getName()).log(Level.SEVERE, null, ex);
                        JOptionPane.showMessageDialog(null, "No se ha podido eliminar la fila","Error",0);
                    }
            }
        }            
    }  
    ...
    public void eliminarTodo(String sentencia){
        ...
        if (opcion == 0){ //ACEPTAR
                try {
                    ...
                    Logger.getLogger(PnlGestion.class.getName()).log(Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(null, "No se han podido eliminar los datos.","Error",0);
                }
        }              
    }
    ...
    private void btnAniadirPasajeroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAniadirPasajeroActionPerformed
        ...
        if (id_tabla == null || id_tabla.isBlank()) { // No se ha seleccionado ningún vehículo
            JOptionPane.showMessageDialog(this, "No ha seleccionado ningún vehículo","Error",0);
        }
        else { 
